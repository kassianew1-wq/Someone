...
**Escore padronizado**: média 50, desvio padrão 10. Nota de cada candidato calculada por:
`NP = ((acertos - média_do_grupo) / DP_do_grupo) × 10 + 50`
Multiplicada pelo peso da prova. Habilitação típica: soma das notas padronizadas ≥ 150.
...
- Tratar pseudonimização como anonimização (dado pseudonimizado ainda é pessoal)
- Atribuir sobredispersão a Poisson (correto: binomial negativa)

## Provas espelho para concursos fazendários
Provas mais próximas do desenho atual da FCC em fazendas estaduais:
